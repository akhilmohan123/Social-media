...
function AiChat() {
    ...
    async function handleSend(e) {
        ...
        const userMessage = { text: newMessage, type: "user", timestamp: new Date() };
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3001/ai/converse', { message: newMessage });
            console.log(response)
            // Append AI response to chat
            const aiMessage = { text: response.data, type: "ai", timestamp: new Date() };
